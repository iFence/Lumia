...
pub(crate) enum TextKey {
    ...
    ProfessionalBundledPluginUnavailable,
...
pub(crate) fn tr(language: Language, key: TextKey) -> &'static str {
    match language {
        Language::English => match key {
            ...
            TextKey::ProfessionalBundledPluginUnavailable => {
                "The bundled preview plugin is missing or unavailable"
            }
            ...
            TextKey::ShortcutOpenSettingsLabel => "Settings",
            TextKey::ShortcutAboutLabel => "About",
            ...
            TextKey::CopyImageInfo => "Copy image info",
            TextKey::CopyExifInfo => "Copy EXIF info",
            TextKey::CopyFilePath => "Copy file path",
            TextKey::Delete => "Delete",
            TextKey::DeleteFailed => "Could not move the file to the recycle bin",
            TextKey::CloseImageInfo => "Close image info",
            TextKey::OpenImageLocation => "View location on map",
            TextKey::OpenFileLocation => "Open file location",
            TextKey::ShowExifInfo => "Show EXIF info",
            ...
            TextKey::AnnotationPlaceHint => "Click to place a text/step, drag to draw a rectangle; Shift-drag to pan",
        ...
        Language::Chinese => match key {
            ...
            TextKey::ProfessionalBundledPluginUnavailable => "内置预览插件缺失或不可用",
            ...
            TextKey::ShortcutOpenSettingsLabel => "设置",
            TextKey::ShortcutAboutLabel => "关于",
            ...
            TextKey::CopyImageInfo => "复制图片信息",
            TextKey::CopyExifInfo => "复制EXIF信息",
            TextKey::CopyFilePath => "复制文件路径",
            TextKey::Delete => "删除",
            TextKey::DeleteFailed => "无法将文件移动到回收站",
            TextKey::CloseImageInfo => "关闭图片信息",
            TextKey::OpenImageLocation => "在地图中查看位置",
            TextKey::OpenFileLocation => "打开所在位置",
            TextKey::ShowExifInfo => "显示EXIF信息",
            ...
            TextKey::AnnotationPlaceHint => "点击放置文字或步骤，拖动绘制矩形框；按住 Shift 拖动可平移",
